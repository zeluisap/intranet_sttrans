<?php
class TransporteVeiculoStatus extends Escola_Entidade {
    ...
    public function getErrors() {
        ...
        $rg = $this->getTable()->fetchAll(" chave = '{$this->chave}' and id_transporte_veiculo_status <> '" . $this->getId() . "' ");
        if ($rg && count($rg)) {
            $msgs[] = "TIPO DE STATUS DO VEÍCULO JÁ CADASTRADO!";
        }
		if (count($msgs)) {
			return $msgs;
		}
