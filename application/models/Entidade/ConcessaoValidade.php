<?php
class ConcessaoValidade extends Escola_Entidade {
    ...
    public function getErrors() {
        ...
        $rg = $this->getTable()->fetchAll(" chave = '{$this->chave}' and id_concessao_validade <> '" . $this->getId() . "' ");
        if ($rg && count($rg)) {
            $msgs[] = "VALIDADE DE CONCESSÃO JÁ CADASTRADO!";
        }
		if (count($msgs)) {
			return $msgs;
		}
