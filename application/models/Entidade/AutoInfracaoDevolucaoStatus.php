<?php
class AutoInfracaoDevolucaoStatus extends Escola_Entidade {
    ...
    public function getErrors() {
        ...
        $rg = $this->getTable()->fetchAll(" chave = '{$this->chave}' and id_auto_infracao_devolucao_status <> '" . $this->getId() . "' ");
        if ($rg && count($rg)) {
            $msgs[] = "STATUS DE DEVOLUÇÃO DE AUTO DE INFRAÇÃO JÁ CADASTRADO!";
        }
		if (count($msgs)) {
			return $msgs;
		}
