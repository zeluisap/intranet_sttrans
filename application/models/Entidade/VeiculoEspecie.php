<?php
class VeiculoEspecie extends Escola_Entidade {
    ...
    public function getErrors() {
        ...
        $rg = $this->getTable()->fetchAll(" chave = '{$this->chave}' and id_veiculo_especie <> '" . $this->getId() . "' ");
        if ($rg && count($rg)) {
            $msgs[] = "ESPÉCIE DE VEÍCULO JÁ CADASTRADO!";
        }
		if (count($msgs)) {
			return $msgs;
		}
