<?php
class MaterialUnidadeTipo extends Escola_Entidade {
    ...
    public function getErrors() {
        ...
        $rg = $this->getTable()->fetchAll(" chave = '{$this->chave}' and id_material_unidade_tipo <> '" . $this->getId() . "' ");
        if ($rg && count($rg)) {
            $msgs[] = "TIPO DE UNIDADE JÁ CADASTRADO!";
        }
		if (count($msgs)) {
			return $msgs;
		}
