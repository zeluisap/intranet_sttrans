<?php
class VeiculoCategoria extends Escola_Entidade {
    ...
    public function getErrors() {
        ...
        $rg = $this->getTable()->fetchAll(" chave = '{$this->chave}' and id_veiculo_categoria <> '" . $this->getId() . "' ");
        if ($rg && count($rg)) {
            $msgs[] = "CATEGORIA DE VEÍCULO JÁ CADASTRADO!";
        }
		if (count($msgs)) {
			return $msgs;
		}
