<?php
class VinculoLoteItem_PJ extends VinculoLoteItem {
    
    protected $referencia = false;

    public function setFromArray(array $dados) {
        if (isset($dados["id_pessoa_juridica"]) && $dados["id_pessoa_juridica"]) {
            $pf = TbPessoaJuridica::pegaPorId($dados["id_pessoa_juridica"]);
            if ($pf) {
