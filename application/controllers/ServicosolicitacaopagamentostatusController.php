<?php 
class ServicosolicitacaopagamentostatusController extends Escola_Controller_Logado {
	...
	public function indexAction() {
		...
		$button->setTitulo("STATUS DE PAGAMENTO DE SOLICITAÇÃO DE SERVIÇO");
	...
	public function editarAction() {
		...
		if ($this->view->registro->getId()) {
			$button->setTitulo("CADASTRO DE STATUS DE PAGAMENTO DE SOLICITAÇÃO DE SERVIÇO - ALTERAR");
		} else {
			$button->setTitulo("CADASTRO DE STATUS DE PAGAMENTO DE SOLICITAÇÃO DE SERVIÇO - INSERIR");
		}
	...
	public function viewAction() {
		...
		if ($id) {
			...
			if ($registro) {
				$this->view->registro = $registro;
				$button = Escola_Button::getInstance();
				$button->setTitulo("VISUALIZAR STATUS DE PAGAMENTO DE SOLICITAÇÃO DE SERVIÇO");
