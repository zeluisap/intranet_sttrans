<?php 
class AutoinfracaoocorrenciatipoController extends Escola_Controller_Logado {
	...
	public function indexAction() {
		...
		$button->setTitulo("CADASTRO DE TIPO DE OCORRÊNCIA DE AUTOS DE INFRAÇÃO");
	...
	public function editarAction() {
		...
		if ($this->view->registro->getId()) {
			$button->setTitulo("CADASTRO DE TIPOS DE OCORRÊNCIA DE AUTO DE INFRAÇÃO - ALTERAR");
		} else {
			$button->setTitulo("CADASTRO DE TIPOS DE OCORRÊNCIA DE AUTO DE INFRAÇÃO - INSERIR");
		}
	...
	public function viewAction() {
		...
		if ($id) {
			...
			if ($registro) {
				$this->view->registro = $registro;
				$button = Escola_Button::getInstance();
				$button->setTitulo("VISUALIZAR TIPO DE OCORRÊNCIA DE AUTO DE INFRAÇÃO");
