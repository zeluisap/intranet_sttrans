<?php 
class PortallayoutController extends Escola_Controller_Logado {
	...
	public function indexAction() {
		...
		$button->setTitulo("LAYOUTS DO PORTAL");
	...
	public function editarAction() {
		...
		if ($this->view->registro->getId()) {
			$button->setTitulo("CADASTRO DE LAYOUTES DO PORTAL - ALTERAR");
		} else {
			$button->setTitulo("CADASTRO DE LAYOUTES DO PORTAL - INSERIR");
		}
	...
	public function viewAction() {
		...
		if ($id) {
			...
			if ($registro) {
				$this->view->registro = $registro;
				$button = Escola_Button::getInstance();
				$button->setTitulo("VISUALIZAR LAYOUTE DO PORTAL");
