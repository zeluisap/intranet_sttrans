<?php
class RelatoriotipoController extends Escola_Controller_Logado {
	...
	public function indexAction() {
		...
		$button->setTitulo("TIPOS DE RELATÓRIOS");
	...
	public function editarAction() {
		...
		if ($this->view->registro->getId()) {
			$button->setTitulo("CADASTRO DE TIPOS DE RELATÓRIO - ALTERAR");
		} else {
			$button->setTitulo("CADASTRO DE TIPOS DE RELATÓRIO - INSERIR");
		}
	...
	public function viewAction() {
		...
		if ($id) {
			...
			if ($registro) {
				$this->view->registro = $registro;
				$button = Escola_Button::getInstance();
				$button->setTitulo("VISUALIZAR TIPO DE RELATÓRIO");
