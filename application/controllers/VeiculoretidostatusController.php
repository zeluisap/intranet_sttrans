<?php 
class VeiculoretidostatusController extends Escola_Controller_Logado {
	...
	public function indexAction() {
		...
		$button->setTitulo("STATUS DE VEÍCULO RETIDO");
	...
	public function editarAction() {
		...
		if ($this->view->registro->getId()) {
			$button->setTitulo("CADASTRO DE STATUS DE VEÍCULO RETIDO - ALTERAR");
		} else {
			$button->setTitulo("CADASTRO DE STATUS DE VEÍCULO RETIDO - INSERIR");
		}
	...
	public function viewAction() {
		...
		if ($id) {
			...
			if ($registro) {
				$this->view->registro = $registro;
				$button = Escola_Button::getInstance();
				$button->setTitulo("VISUALIZAR STATUS DE VEÍCULO RETIDO");
