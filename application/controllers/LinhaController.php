<?php 
class LinhaController extends Escola_Controller_Logado {
	...
	public function editarAction() {
		...
		if ($this->view->registro->getId()) {
			$button->setTitulo("CADASTRO DE LINHA - ALTERAR");
		} else {
			$button->setTitulo("CADASTRO DE LINHA - INSERIR");
		}
	...
	public function viewAction() {
		...
		if ($id) {
			...
			if ($registro) {
				$this->view->registro = $registro;
				$button = Escola_Button::getInstance();
				$button->setTitulo("VISUALIZAR LINHA");
