<?php 
class ConcessaovalidadeController extends Escola_Controller_Logado {

	public function indexAction() {
		$tb = new TbConcessaoValidade();
		$page = $this->_getParam("page");
		$this->view->registros = $tb->listar_por_pagina(array("pagina_atual" => $page));
		$button = Escola_Button::getInstance();
		$button->setTitulo("VALIDADES DE CONCESSÃO");
	...
	public function editarAction() {
		...
		if ($this->view->registro->getId()) {
			$button->setTitulo("CADASTRO DE VALIDADE DE CONCESSÃO - ALTERAR");
		} else {
			$button->setTitulo("CADASTRO DE VALIDADE DE CONCESSÃO - INSERIR");
		}
	...
	public function viewAction() {
		...
		if ($id) {
			...
			if ($registro) {
				$this->view->registro = $registro;
				$button = Escola_Button::getInstance();
				$button->setTitulo("VISUALIZAR VALIDADE DE CONCESSÃO");
