<?php 
class VinculopessoatipoController extends Escola_Controller_Logado {
	...
	public function indexAction() {
		...
		$button->setTitulo("TIPO DE VÍNCULO COM PESSOA");
	...
	public function editarAction() {
		...
		if ($this->view->registro->getId()) {
			$button->setTitulo("CADASTRO DE TIPO DE VÍNCULO COM PESSOA - ALTERAR");
		} else {
			$button->setTitulo("CADASTRO DE TIPO DE VÍNCULO COM PESSOA - INSERIR");
		}
	...
	public function viewAction() {
		...
		if ($id) {
			...
			if ($registro) {
				$this->view->registro = $registro;
				$button = Escola_Button::getInstance();
				$button->setTitulo("VISUALIZAR TIPO DE VÍNCULO COM PESSOA");
