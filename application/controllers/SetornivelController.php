<?php 
class SetornivelController extends Escola_Controller_Logado {
	...
	public function indexAction() {
		...
		$button->setTitulo("NÍVEIS DE SETOR");
	...
	public function editarAction() {
		...
		if ($this->view->registro->getId()) {
			$button->setTitulo("CADASTRO DE NÍVEIS DE SETOR - ALTERAR");
		} else {
			$button->setTitulo("CADASTRO DE NÍVEIS DE SETOR - INSERIR");
		}
	...
	public function viewAction() {
		...
		if ($id) {
			...
			if ($registro) {
				$this->view->registro = $registro;
				$button = Escola_Button::getInstance();
				$button->setTitulo("VISUALIZAR NÍVEL DE SETOR");
