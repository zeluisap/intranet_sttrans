<?php 
class ServicoreferenciaController extends Escola_Controller_Logado {
	...
	public function indexAction() {
		...
		$button->setTitulo("REFERÊNCIA DE SERVIÇO");
	...
	public function editarAction() {
		...
		if ($this->view->registro->getId()) {
			$button->setTitulo("CADASTRO DE REFERÊNCIA DE SERVIÇO - ALTERAR");
		} else {
			$button->setTitulo("CADASTRO DE REFERÊNCIA DE SERVIÇO - INSERIR");
		}
	...
	public function viewAction() {
		...
		if ($id) {
			...
			if ($registro) {
				$this->view->registro = $registro;
				$button = Escola_Button::getInstance();
				$button->setTitulo("VISUALIZAR REFERÊNCIA DE SERVIÇO");
