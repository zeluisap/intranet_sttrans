<?php 
class TransportepessoatipoController extends Escola_Controller_Logado {
	...
	public function indexAction() {
		...
		$button->setTitulo("TIPOS DE VÍNCULO TRANSPORTE > PESSOA");
	...
	public function editarAction() {
		...
		if ($this->view->registro->getId()) {
			$button->setTitulo("CADASTRO DE TIPO DE VÍNCULO TRANSPORTE > PESSOA- ALTERAR");
		} else {
			$button->setTitulo("CADASTRO DE TIPO DE VÍNCULO TRANSPORTE > PESSOA - INSERIR");
		}
	...
	public function viewAction() {
		...
		if ($id) {
			...
			if ($registro) {
				$this->view->registro = $registro;
				$button = Escola_Button::getInstance();
				$button->setTitulo("VISUALIZAR TIPO DE VÍNCULO TRANSPORTE > PESSOA");
