<?php 
class OnibusparadatipoController extends Escola_Controller_Logado {
    
	public function indexAction() {
		$tb = new TbOnibusParadaTipo();
                $tb->recuperar();
		$page = $this->_getParam("page");
		$this->view->registros = $tb->listar_por_pagina(array("pagina_atual" => $page));
		$button = Escola_Button::getInstance();
		$button->setTitulo("TIPO DE PARADA DE ONIBUS");
	...
	public function editarAction() {
		...
		if ($this->view->registro->getId()) {
			$button->setTitulo("CADASTRO DE TIPO DE PARADA DE ONIBUS - ALTERAR");
		} else {
			$button->setTitulo("CADASTRO DE TIPO DE PARADA DE ONIBUS - INSERIR");
		}
	...
	public function viewAction() {
		...
		if ($id) {
			...
			if ($registro) {
				$this->view->registro = $registro;
				$button = Escola_Button::getInstance();
				$button->setTitulo("VISUALIZAR TIPO DE PARADA DE ONIBUS");
