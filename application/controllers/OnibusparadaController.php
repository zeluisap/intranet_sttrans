<?php 
class OnibusparadaController extends Escola_Controller_Logado {
	...
	public function indexAction() {
		...
		$button->setTitulo("PARADA DE ONIBUS");
	...
	public function editarAction() {
		...
		if ($this->view->registro->getId()) {
			$button->setTitulo("CADASTRO DE PARADA DE ONIBUS - ALTERAR");
		} else {
			$button->setTitulo("CADASTRO DE PARADA DE ONIBUS - INSERIR");
		}
    ...
    public function viewAction() {
        ...
        if ($id) {
            ...
            if ($registro) {
                $this->view->registro = $registro;
                $tb = new TbRotaParada();
                $this->view->rps = $tb->listar(array("id_onibus_parada" => $registro->getId()));
                $button = Escola_Button::getInstance();
                $button->setTitulo("VISUALIZAR PARADA DE ONIBUS");
