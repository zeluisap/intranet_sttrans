<?php 
class CredencialstatusController extends Escola_Controller_Logado {
	...
	public function indexAction() {
		...
		$button->setTitulo("CADASTRO DE STATUS DE CREDENCIAL");
	...
	public function editarAction() {
		...
		if ($this->view->registro->getId()) {
			$button->setTitulo("CADASTRO DE STATUS DE CREDENCIAIS - ALTERAR");
		} else {
			$button->setTitulo("CADASTRO DE STATUS DE CREDENCIAIS - INSERIR");
		}
	...
	public function viewAction() {
		...
		if ($id) {
			...
			if ($registro) {
				$this->view->registro = $registro;
				$button = Escola_Button::getInstance();
				$button->setTitulo("VISUALIZAR STATUS DE CREDENCIAIS");
