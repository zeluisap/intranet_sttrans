<?php
class Escola_Form_Element_Select_Table_Crud_Inline_Combustivel extends Escola_Form_Element_Select_Table {
	
    public function init() {
        parent::init();
        $this->setPkName("id_combustivel");
        $this->setModel("TbCombustivel");        
    }
...
<?php }} ?>
                    ...
                    <div class="well well-small hide" id="<?php echo $this->getName(); ?>_input_edicao">
                            <legend>Adicionar Combustível</legend>
                            <div class="alert">
