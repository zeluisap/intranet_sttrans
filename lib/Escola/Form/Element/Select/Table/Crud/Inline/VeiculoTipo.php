<?php
class Escola_Form_Element_Select_Table_Crud_Inline_VeiculoTipo extends Escola_Form_Element_Select_Table {
	
    public function init() {
        parent::init();
        $this->setPkName("id_veiculo_tipo");
        $this->setModel("TbVeiculoTipo");        
    }
...
<?php }} ?>
                    ...
                    <div class="well well-small hide" id="<?php echo $this->getName(); ?>_input_edicao">
                            <legend>Adicionar Tipo de Veículo</legend>
                            <div class="alert">
