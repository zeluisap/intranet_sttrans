<?php
class Escola_Form_Element_Select_Table_Crud_Inline_VeiculoCategoria extends Escola_Form_Element_Select_Table {
	
    public function init() {
        parent::init();
        $this->setPkName("id_veiculo_categoria");
        $this->setModel("TbVeiculoCategoria");
    }
...
<?php }} ?>
                    ...
                    <div class="well well-small hide" id="<?php echo $this->getName(); ?>_input_edicao">
                            <legend>Adicionar Categoria de Veículo</legend>
                            <div class="alert">
