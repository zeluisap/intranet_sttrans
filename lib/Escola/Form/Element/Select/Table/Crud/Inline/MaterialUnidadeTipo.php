<?php
class Escola_Form_Element_Select_Table_Crud_Inline_MaterialUnidadeTipo extends Escola_Form_Element_Select_Table {
	
    public function init() {
        parent::init();
        $this->setPkName("id_material_unidade_tipo");
        $this->setModel("TbMaterialUnidadeTipo");
    }
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        $("#<?php echo $this->getName(); ?>_btn_salvar").click(function() {
            ajax = $.ajax({
                "url" : "<?php echo $view->baseUrl(); ?>/materialunidadetipo/salvar/format/json/",
                "type" : "POST",
                "data" : { "chave" : $("#<?php echo $this->getName(); ?>_chave").val(), "descricao" : $("#<?php echo $this->getName(); ?>_descricao").val() },
    ...
    function reload_crud_<?php echo $this->getName(); ?>(default_id) {
        ...
        ajax = $.ajax({
            "url" : "<?php echo $view->baseUrl(); ?>/materialunidadetipo/listar/format/json/",
            "type" : "POST",
            "success" : function(obj_view) {
                if (obj_view.result) {
...
<?php }} ?>
                    ...
                    <div class="well well-small hide" id="<?php echo $this->getName(); ?>_input_edicao">
                            <legend>Adicionar Tipo de Unidade</legend>
                            <div class="alert">
