            ...
            <tr>
                ...
                <td width="580" rowspan="2">
                    ...
                    <table>
                        ...
                        <tr>
                            <td align="center" style="font-weight: bold;">CONFORME LEI FEDERAL N.: 9.503</td>
                        </tr>
                        <tr>
                            <td align="center" style="font-weight: bold;">(RESOLUÇÃO 304/2008 DO CONTRAN)</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        <td class="font_10 indent_1">2.4. O uso do cartão em desacordo com as disposições nele contidas ou na legislação pertinente, especialmente se constatado pelo agente que o veículo por ocasião da utilização vaga especial, não serviu para o transporte do deficiente físico:</td>
                                    </tr>
                                    <tr>
                                        <td class="font_10 indent_1">2.5. O uso do cartão com validade vencida.</td>
                                    </tr>
                                    <tr>
                                        <td class="font_10">3. A presente autorização somente é válida para estacionar nas vagas devidamente sinalizadas com o símbolo Internacional de Acesso, especialmente criadas pelo órgão de trânsito para esse fim.</td>
                                    </tr>
                                    <tr>
